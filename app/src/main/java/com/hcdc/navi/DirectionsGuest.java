...
public class DirectionsGuest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_directions_guest);
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (button==findViewById(R.id.btn1)) {
                        Intent intent = new Intent(DirectionsGuest.this, AdmissionOffice.class);
                        intent.putExtra("userId", savedUserId);
                        startActivity(intent);
                    } else if (button==findViewById(R.id.btn2)) {
                        Intent intent = new Intent(DirectionsGuest.this, OSA.class);
                        intent.putExtra("userId", savedUserId);
                        startActivity(intent);
                    } else if (button==findViewById(R.id.btn3)) {
                        Intent intent = new Intent(DirectionsGuest.this, Restroom.class);
                        intent.putExtra("userId", savedUserId);
                        startActivity(intent);
                    } else if (button==findViewById(R.id.btn4)) {
                        Intent intent = new Intent(DirectionsGuest.this, Gym.class);
                        intent.putExtra("userId", savedUserId);
                        startActivity(intent);
                    }
                }
