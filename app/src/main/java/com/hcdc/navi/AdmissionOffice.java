...
public class AdmissionOffice extends AppCompatActivity {
    TextView details;
    ...
    String[]detailsText={
            ...
            "Head straight down the corridor until you reach the Admission Office"
    };

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admission_office);
